...
This project is not open source. If you'd like to support its development, please contact us for more information.
...
Elixir API is [MIT licensed](https://github.com/ksthecrowned/exlixir-api/blob/main/LICENSE).
